const scope={
 ...
 localStorage.setItem("p1",JSON.stringify(scope));
 ...
 localStorage.setItem("p2",JSON.stringify(hoisting));
 ...
 localStorage.setItem("p3",JSON.stringify(constructor_functions));
 ...
 localStorage.setItem("p4",JSON.stringify(prototype));




 
let scopedata=JSON.parse(localStorage.getItem("p1"))||[];
let hostdata=JSON.parse(localStorage.getItem("p2"))||[];
let constrdata=JSON.parse(localStorage.getItem("p3"))||[];
let prodata=JSON.parse(localStorage.getItem("p4"))||[];
let btn_arr=["p1","p2","p3","p4"];
